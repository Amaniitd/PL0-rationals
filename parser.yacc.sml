...
\\001\000\002\000\011\000\003\000\010\000\007\000\017\000\000\000\
\\001\000\008\000\000\000\000\000\
\\019\000\002\000\011\000\003\000\010\000\000\000\
\\020\000\004\000\009\000\005\000\008\000\000\000\
\\021\000\004\000\009\000\005\000\008\000\000\000\
\\022\000\004\000\009\000\005\000\008\000\000\000\
\\023\000\000\000\
\\024\000\000\000\
\\025\000\000\000\
\\026\000\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 | INT of unit ->  (R.rational) | Unit of unit ->  (AST.exp)
...
|  ( 4, ( ( _, ( MlyValue.Unit Unit1, _, Unit1right)) :: _ :: ( _, ( 
...
MlyValue.Term (fn _ => let val  (Term as Term1) = Term1 ()
 ...
 in ( LrTable.NT 2, ( result, Term1left, Unit1right), rest671)
end
|  ( 5, ( ( _, ( MlyValue.Unit Unit1, _, Unit1right)) :: _ :: ( _, ( 
MlyValue.Term Term1, Term1left, _)) :: rest671)) => let val  result = 
MlyValue.Term (fn _ => let val  (Term as Term1) = Term1 ()
 val  (Unit as Unit1) = Unit1 ()
...
|  ( 6, ( ( _, ( MlyValue.Unit Unit1, Unit1left, Unit1right)) :: 
rest671)) => let val  result = MlyValue.Term (fn _ => let val  (Unit
 as Unit1) = Unit1 ()
 in (Unit)
end)
 in ( LrTable.NT 2, ( result, Unit1left, Unit1right), rest671)
end
