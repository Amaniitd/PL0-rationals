...
val list_of_tests = [
    (Rational.showRat(Rational.fromDecimal("1.2(0)")), "1.2(0)"),
    (Rational.showRat(Rational.add(Rational.fromDecimal("+100.(0)"), Rational.fromDecimal("~200.(0)"))), "~100.(0)"),
    (Rational.showRat(Rational.subtract(Rational.fromDecimal("1000.(0)"), Rational.fromDecimal("0.00001(0)"))), "999.99999(0)"),
    (Rational.showRat(Rational.multiply(Rational.fromDecimal("1000000.(0)"), Rational.fromDecimal("1000000.(0)"))), "1000000000000.(0)"),
